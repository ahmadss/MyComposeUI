...
data class ThemeData(val title: String, val value: Boolean)
...
fun ThemeDemo() {
    val mode = remember {
        mutableStateOf(ThemeData(ThemeMode.Light, false))
    }
                ...
                Column(content = {
                    ...
                    Row {
                        ...
                        RadioButton(
                            ...
                            onClick = { mode.value = ThemeData(ThemeMode.Dark, true) })
                        ...
                        RadioButton(
                            ...
                            onClick = { mode.value = ThemeData(ThemeMode.Light, false) })
                        Spacer(modifier = Modifier.size(8.dp))
                        Text(
                    ...
                    val name = "Achmad Saifuddin"
                    val gender = "Male"
                    val emailId = "Saifuddinahmad12@gmail.com"
                    Spacer(modifier = Modifier.size(16.dp))
